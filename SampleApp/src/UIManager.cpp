    ...
    if (m_connectionStatus == avsCommon::sdkInterfaces::ConnectionStatusObserverInterface::Status::DISCONNECTED) {
        ...
        switch (m_dialogState) {
            case DialogUXState::IDLE:
                ...
                system("/home/pi/sdk-folder/third-party/pi_hat_ctrl/pi_hat_ctrl SET_EXTERNAL_GPIO 0");
#endif
                return;
            case DialogUXState::LISTENING:
                ...
                system("/home/pi/sdk-folder/third-party/pi_hat_ctrl/pi_hat_ctrl SET_EXTERNAL_GPIO 1");
#endif
                return;
